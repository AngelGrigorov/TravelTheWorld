<template>
  ...
  export default {
    ...
    emailRules: [
      ...
      value => value.indexOf('@') !== 0 || 'Email should be valid.',
      value => value.includes('@') || 'Email should be valid.',
      value => value.indexOf('.') - value.indexOf('@') > 1 || 'Email should be valid.',
      value => value.indexOf('.') <= value.length - 3 || 'Email should be valid.',
    ],
